 ...
 */
@Component
public class VisitorExpiredRouteBuilder extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		.routeId("VISITOR_EXPIRED_ROUTER")
			...
			.bean(AlarmCommonUtils.class, "onVisitorDateExpired") // This is RfidVisitor.java
			.setProperty("ALARM_DETAILS", body()) // This is AlarmDto.java
			.bean(AlarmCommonUtils.class, "onAlarmSearch")
			.log("Search Request VISITOR_EXPIRED_ROUTER ${body}")
			...
			.choice()
				...
				.endChoice()
			.endChoice()
			.otherwise().log("Alarm Already exists for visitor date Expiration");
	}
}
